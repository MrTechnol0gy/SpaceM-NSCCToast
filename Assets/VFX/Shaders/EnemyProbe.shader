...
Shader "EnemyProbe"
{
	Properties
	{
		...
		_TilingOffset("TilingOffset", Float) = 0
		_TilingOffset2("TilingOffset2", Float) = 0
		_Speed("Speed", Float) = 0.5
		[ASEEnd]_Speed2("Speed2", Float) = 0.5
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 temp_cast_0 = (_TilingOffset2).xx;
				float mulTime24 = _TimeParameters.x * _Speed2;
				float2 temp_cast_1 = (mulTime24).xx;
				float2 texCoord22 = v.texcoord.xy * temp_cast_0 + temp_cast_1;
				float2 temp_cast_2 = (_TilingOffset).xx;
				float mulTime20 = _TimeParameters.x * _Speed;
				float2 temp_cast_3 = (mulTime20).xx;
				float2 texCoord17 = v.texcoord.xy * temp_cast_2 + temp_cast_3;
				float temp_output_14_0 = ( 1.0 - tex2Dlod( _TextureSample0, float4( ( texCoord22 + texCoord17 ), 0, 0.0) ).r );
				...
				float3 vertexValue = ( v.ase_normal * temp_output_14_0 * _Intensity );
						 ...
						 ) : SV_Target
			{
				...
				float mulTime24 = _TimeParameters.x * _Speed2;
				float2 temp_cast_1 = (mulTime24).xx;
				float2 texCoord22 = IN.ase_texcoord8.xy * temp_cast_0 + temp_cast_1;
				float2 temp_cast_2 = (_TilingOffset).xx;
				float mulTime20 = _TimeParameters.x * _Speed;
				float2 temp_cast_3 = (mulTime20).xx;
				float2 texCoord17 = IN.ase_texcoord8.xy * temp_cast_2 + temp_cast_3;
				float temp_output_14_0 = ( 1.0 - tex2D( _TextureSample0, ( texCoord22 + texCoord17 ) ).r );
				

				float3 BaseColor = ( ( _Color0 * temp_output_14_0 ) + float4( 0,0,0,0 ) ).rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = ( _Color1 * temp_output_14_0 ).rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float mulTime24 = _TimeParameters.x * _Speed2;
				float2 temp_cast_1 = (mulTime24).xx;
				float2 texCoord22 = v.ase_texcoord.xy * temp_cast_0 + temp_cast_1;
				float2 temp_cast_2 = (_TilingOffset).xx;
				float mulTime20 = _TimeParameters.x * _Speed;
				float2 temp_cast_3 = (mulTime20).xx;
				float2 texCoord17 = v.ase_texcoord.xy * temp_cast_2 + temp_cast_3;
				float temp_output_14_0 = ( 1.0 - tex2Dlod( _TextureSample0, float4( ( texCoord22 + texCoord17 ), 0, 0.0) ).r );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float mulTime24 = _TimeParameters.x * _Speed2;
				float2 temp_cast_1 = (mulTime24).xx;
				float2 texCoord22 = v.texcoord0.xy * temp_cast_0 + temp_cast_1;
				float2 temp_cast_2 = (_TilingOffset).xx;
				float mulTime20 = _TimeParameters.x * _Speed;
				float2 temp_cast_3 = (mulTime20).xx;
				float2 texCoord17 = v.texcoord0.xy * temp_cast_2 + temp_cast_3;
				float temp_output_14_0 = ( 1.0 - tex2Dlod( _TextureSample0, float4( ( texCoord22 + texCoord17 ), 0, 0.0) ).r );
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float mulTime24 = _TimeParameters.x * _Speed2;
				float2 temp_cast_1 = (mulTime24).xx;
				float2 texCoord22 = IN.ase_texcoord4.xy * temp_cast_0 + temp_cast_1;
				float2 temp_cast_2 = (_TilingOffset).xx;
				float mulTime20 = _TimeParameters.x * _Speed;
				float2 temp_cast_3 = (mulTime20).xx;
				float2 texCoord17 = IN.ase_texcoord4.xy * temp_cast_2 + temp_cast_3;
				float temp_output_14_0 = ( 1.0 - tex2D( _TextureSample0, ( texCoord22 + texCoord17 ) ).r );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float mulTime24 = _TimeParameters.x * _Speed2;
				float2 temp_cast_1 = (mulTime24).xx;
				float2 texCoord22 = IN.ase_texcoord2.xy * temp_cast_0 + temp_cast_1;
				float2 temp_cast_2 = (_TilingOffset).xx;
				float mulTime20 = _TimeParameters.x * _Speed;
				float2 temp_cast_3 = (mulTime20).xx;
				float2 texCoord17 = IN.ase_texcoord2.xy * temp_cast_2 + temp_cast_3;
				float temp_output_14_0 = ( 1.0 - tex2D( _TextureSample0, ( texCoord22 + texCoord17 ) ).r );
...
Node;AmplifyShaderEditor.SamplerNode;10;-491.5,-84.5;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.NormalVertexDataNode;11;-413.5,159.5;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;13;-381.5,329.5;Inherit;False;Property;_Intensity;Intensity;1;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;287,2;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;EnemyProbe;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;19;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;41;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;1;638199430809187685;  Phong;1;638199430842792612;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;12;-32.5,231.5;Inherit;False;3;3;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleTimeNode;24;-1464.797,-314.2375;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;25;-1714.797,-296.2376;Inherit;False;Property;_Speed2;Speed2;7;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;23;-1449.797,-444.2375;Inherit;False;Property;_TilingOffset2;TilingOffset2;5;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;22;-1171.991,-479.1779;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;17;-1168.179,-168.4992;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;18;-1454.18,-167.4992;Inherit;False;Property;_TilingOffset;TilingOffset;4;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;20;-1469.18,-37.49931;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;21;-1719.18,-19.49929;Inherit;False;Property;_Speed;Speed;6;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;26;-842.2753,-257.0989;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ColorNode;16;-461.3679,-539.0263;Inherit;False;Property;_Color0;Color 0;2;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;27;-456.4321,-313.6703;Inherit;False;Property;_Color1;Color1;3;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;22.8401,-390.7843;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;28;25.15002,-264.352;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;29;228.8688,-276.27;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.OneMinusNode;14;-165,-53.59999;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=F503788801F9F26FF8595D89F22200F931D28BD0